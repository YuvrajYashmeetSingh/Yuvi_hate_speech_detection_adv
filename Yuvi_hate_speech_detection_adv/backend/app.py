...
model = pickle.load(open('models/dtc_models/yuvraj_hate_speech(1).pkl', 'rb'))  # Loading ML model using pickle
cv = pickle.load(open('models/dtc_models/count_vectorizer.pkl', 'rb'))  # Loading count vectorizer using pickle

#using SVM

#model = pickle.load(open('svm_hate_speech.pkl', 'rb'))  # Loading ML model using pickle
#cv = pickle.load(open('count_vectorizer_svm.pkl', 'rb'))  # Loading count vectorizer using pickle
